...
from yousta.views import SignUpView,SignInView,CategoryCreateView,remove_category,ClothCreateView,\
      ClothListView,ClothUpdateView,remove_clothview,ClothVarientCreateView,ClothDetailView,ClothVarientUpdateView,remove_varient,\
      OfferCreateView,offer_delete_view,sign_out_view,IndexView
